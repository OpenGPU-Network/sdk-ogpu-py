"""Sync Web3 instance manager. Cached per chain."""
...
class Web3Manager:
    ...
    def update_rpc_url(cls, chain_id: ChainId, rpc_url: str) -> None:
        """Update RPC URL for a specific chain and invalidate the cached instance."""
...
def WEB3() -> Web3:
    """Shortcut — returns the Web3 instance for the current chain."""
